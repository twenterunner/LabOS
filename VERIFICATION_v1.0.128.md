# LabOS REV 1.0.128 — Verification Summary
...
- `index.html` references only REV 1.0.128 runtime filenames.
- Version badge/runtime core: REV 1.0.128 / `1.0.128-poc`.
- ZIP integrity: PASS.
...
The REV 1.0.128 commit path was then exercised with an actual shifted feasible task:
...
## REV 1.0.128 manual/AUTO-PLAN policy verification
...
## Business Unit migration acceptance
- Legacy collapsed demo state reproduced before repair.
- In-place migration produces five controlled BU snapshots across the canonical 24 demo requests.
- Default 13-week KPI source bookings contain multiple BU allocations at each of the three labs.
- State invariants: 0.
- Planning-integrity findings: 0.
