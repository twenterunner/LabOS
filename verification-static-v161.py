...
add('All JS/CSS assets use REV 1.0.61 cache busting',bool(versioned) and all('?v=1.0.61' in r for r in versioned))
add('Visible revision badge is REV 1.0.61','>REV 1.0.61<' in text)
add('Core version/schema are 1.0.59 / 29',"ProtoLab.VERSION = '1.0.61-poc'" in core and 'ProtoLab.SCHEMA_VERSION = 29' in core)
