# LabOS REV 1.0.185 — Management Demo Guide

## REV 1.0.185 planning recovery

Planning is treated as a release-critical function in this revision. Overall, per-programme and per-equipment views continue to use the same constrained planning model. REV 1.0.185 specifically hardens Overall swim-lane interaction, target-lab resource scoping, manual replan access and the formal sister-lab request/approval handshake.
...
Open **Help → Management Demo**. REV 1.0.185 contains 16 prepared showcase records. The strongest new end-to-end example is **V26-0205**.
...
## Planning interaction additions in REV 1.0.185
