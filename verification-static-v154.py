...
add('All JS/CSS assets use REV 1.0.54 cache busting',bool(versioned) and all('?v=1.0.54' in r for r in versioned))
add('Visible revision badge is REV 1.0.54','>REV 1.0.54<' in text)
add('Core version/schema are 1.0.54 / 27',"ProtoLab.VERSION = '1.0.54-poc'" in core and 'ProtoLab.SCHEMA_VERSION = 27' in core)
