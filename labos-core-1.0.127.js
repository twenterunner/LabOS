(function(){
  ...
  ProtoLab.ensureEnterpriseModel = state => {
    ...
    // REV 1.0.127 — preserve commercial evidence provenance when benchmark terms change.
  ...
  /* ============================================================
     LabOS REV 1.0.127 — controlled Business Unit master data.
