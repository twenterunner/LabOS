(function(){
  ...
  ProtoLab.materialPlanningAssessment = (state,r) => {
    ...
    if(r.materialOwnership==='Engineering supplied'){
      const supply=r.materialSupply||{}; const planningReady=issuedReady||!!(supply.expectedDate&&supply.owner),commitmentReady=issuedReady||(planningReady&&(supply.committed===true||supply.commitmentStatus==='Committed')),partial=outputLimit.maxBuildQty>0&&!issuedReady;
