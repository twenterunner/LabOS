(function(){
  ...
  ProtoLab.PERMISSIONS = {
    ...
    lab_planner:['request:view','triage','plan','route:edit','materials:allocate','materials:receive','product:view','report:view','improvement:review'], process_engineer:['request:view','route:edit','process:develop','process:release','workinstruction:edit','product:view','report:view'], validation_engineer:['request:create','request:view','plan','route:edit','process:develop','execution:run','evidence:add','measurement:add','product:view','report:view','improvement:review'],
...
/* ============================================================
   LabOS REV 1.0.151 — enterprise KPI definition + event model.
...
(function(P){
  ...
  P.seedKpiDemoFactsV151=state=>{
    ...
    state.settings.kpiDemoSeedV151='1.0.151';state.settings.kpiModelVersion='1.0.151';return {changed:true,history:hist.length,delays:state.kpiFactsV151.delays.length,quality:state.kpiFactsV151.quality.length,capacity:state.kpiFactsV151.capacity.length};
  };
})(window.ProtoLab);
