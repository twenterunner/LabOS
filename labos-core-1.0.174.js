...
/* ============================================================
   LabOS REV 1.0.174 — Validation test-flow snapshot and controlled
...
(function installV172ValidationReportEvidence(P){
  ...
  P.validationReportV161=(state,pid,{persist=false}={})=>{
    ...
    report.testFlow=flow?clone(flow):{version:'1.0.174',legs:[]};
...
/* ============================================================
   LabOS REV 1.0.174 — controlled Prototype→Validation dependency
