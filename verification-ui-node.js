...
checks.push(['visible revision badge is populated',els['#versionBadge'].textContent==='REV 1.0.5']);
...
checks.push(['standard tests and lab skills are exposed as planning master data',appSource.includes('STANDARD TEST LIBRARY')&&appSource.includes('SKILLS / QUALIFICATION')&&appSource.includes('Lab team competency matrix')]);
