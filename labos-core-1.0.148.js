(function(){
  ...
  ProtoLab.VERSION = '1.0.148-poc';
  ProtoLab.SCHEMA_VERSION = 36;
...
/* ============================================================
   LabOS REV 1.0.148 — product-scoped Control Plan selection.
...
/* ============================================================
   LabOS REV 1.0.148 — resilient equipment planning capability.
...
/* ============================================================
   LabOS REV 1.0.148 — canonical resource semantics.
...
/* REV 1.0.148 — migrate legacy resource semantics at the model boundary.
