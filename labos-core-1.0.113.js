    ...
    (route?.steps||[]).forEach(s=>{
      ...
      if(s.type==='standard'){
        if(!proc){
          ...
          if(!ProtoLab.planningCapabilityForProcess(state,r,proc)&&!/material receipt|cleaning|assembly|packaging/i.test(s.name||''))issues.push(`${s.name}: equipment capability could not be inferred or defined.`);
