# LabOS REV 1.0.184 — Management Demo Guide
...
Open **Help → Management Demo**. REV 1.0.184 contains 16 prepared showcase records. The strongest new end-to-end example is **V26-0205**.
...
## Planning interaction additions in REV 1.0.184
