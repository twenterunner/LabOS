...
/* ============================================================
   LabOS REV 1.0.162 — shared Programme model.
...
/* ============================================================
   LabOS REV 1.0.162 — enterprise KPI definition + event model.
...
(function(P){
  ...
  P.seedKpiDemoFactsV151=state=>{
    ...
    state.settings.kpiDemoSeedV151='1.0.162';state.settings.kpiModelVersion='1.0.162';return {changed:true,history:hist.length,delays:state.kpiFactsV151.delays.length,quality:state.kpiFactsV151.quality.length,capacity:state.kpiFactsV151.capacity.length};
  };
})(window.ProtoLab);

/* ============================================================
   LabOS REV 1.0.162 — unified visual Programme Builder model.
...
(function installProgrammeBuilderV162(P){
  ...
  function migrate(state,type,id){
    ...
    const structure={id:key(type,id),programmeType:type,entityId:id,modelVersion:'1.0.162',createdAt:now(),updatedAt:now(),layoutDirection:'LR',overlay:'structure',lanes:clone(src.lanes),activities:clone(src.activities),templatesUsed:[],revisionHistory:[]};
  ...
  P.ensureProgrammeBuilderV162=(state,{type=null,id=null}={})=>{
    ...
    state.settings=state.settings||{};if(!state.settings.programmeBuilderV162){state.settings.programmeBuilderV162={modelVersion:'1.0.162',migratedAt:now()};changed=true}
    return {changed};
  };
