...
/* ============================================================
   LabOS REV 1.0.161 — shared Programme model.
...
/* ============================================================
   LabOS REV 1.0.161 — enterprise KPI definition + event model.
...
(function(P){
  ...
  P.seedKpiDemoFactsV151=state=>{
    ...
    state.settings.kpiDemoSeedV151='1.0.161';state.settings.kpiModelVersion='1.0.161';return {changed:true,history:hist.length,delays:state.kpiFactsV151.delays.length,quality:state.kpiFactsV151.quality.length,capacity:state.kpiFactsV151.capacity.length};
  };
})(window.ProtoLab);
