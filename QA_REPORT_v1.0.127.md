# LabOS REV 1.0.127 — Controlled Business Units + Planning/KPI Regression QA

**Audit date:** 15 September 2026  
**Audit target:** `ProtoLabOS_Prototype_Build_POC_v1.0.127_WEB.zip`  
**Regression base:** REV 1.0.126  
**Accepted historical reference:** REV 1.0.98  
**Schema:** 35

## Executive result
REV 1.0.127 introduces **controlled Business Unit master data** in Configuration. Project Teams no longer accept a free-format Business Unit string: they select a governed Business Unit record with a stable ID, optional short code and active/inactive state. Existing free-text values migrate automatically, and requests retain a Business Unit snapshot so historical selected-period KPI allocation remains stable when the organization later changes.
...
## 2. Replan rationale — before vs REV 1.0.127
### Before
...
REV 1.0.127 replaces the Project Team free-text Business Unit field with controlled organization master data.
