...
- REV 1.0.127 commits and verifies a move by the stable canonical task identity (`requestId + stepId`) and then verifies the prevalidated date/equipment/person assignment.
