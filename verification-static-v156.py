...
add('All JS/CSS assets use REV 1.0.56 cache busting',bool(versioned) and all('?v=1.0.56' in r for r in versioned))
add('Visible revision badge is REV 1.0.56','>REV 1.0.56<' in text)
add('Core version/schema are 1.0.56 / 27',"ProtoLab.VERSION = '1.0.56-poc'" in core and 'ProtoLab.SCHEMA_VERSION = 28' in core)
