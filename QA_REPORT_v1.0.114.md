# LabOS REV 1.0.114 — targeted controls-stage regression report
...
A Node execution harness loaded the real REV 1.0.114 core, demo dataset and services and exercised the actual data-model functions.
...
- all runtime references in `index.html` resolve to REV 1.0.114 assets;
