(function(){
  ...
  ProtoLab.ensureDemoBusinessUnitDiversityV128 = state => {
    ...
    if(['migrated-legacy-demo','verified-diverse','preserved-user-allocation','not-applicable'].includes(state.settings.demoBusinessUnitDistributionV128))return state;
