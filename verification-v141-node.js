...
t('Release is v1.0.41 schema 21',()=>{assert.equal(P.VERSION,'1.0.41-poc');assert.equal(P.SCHEMA_VERSION,21)});
...
t('Versioned assets point to v1.0.41',()=>{assert(index.includes('styles.css?v=1.0.41'));assert(index.includes('app.js?v=1.0.41'));assert(index.includes('REV 1.0.41'))});
