# LabOS REV 1.0.97 — GitHub Pages deployment
...
4. Open the site. The header must show **REV 1.0.97** and the dashboard should render immediately.
...
See `ROOT_CAUSE_PROOF_v1.0.97.md` and `VERIFICATION_v1.0.97.md`.
