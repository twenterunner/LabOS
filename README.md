...
**Current prototype release: REV 1.0.136**  
**Data schema: 35**
...
4. Refresh the page and confirm the header shows **REV 1.0.136**.
...
- `labos-core-1.0.136.js`, `labos-services-1.0.136.js`, `labos-repository-1.0.136.js`, `labos-demo-data-1.0.136.js`, `labos-app-1.0.136.js` — application runtime.
- `labos-styles-1.0.136.css` — application styling.
...
## REV 1.0.136 workflow behavior
- A complete solver-valid manual plan can be committed directly; AUTO-PLAN is optional.
- Control Plan creation from the Controls step opens the actual editor immediately.
- Demo data contains evidence-rich archived and near-sign-off Prototype dossiers for report/Control Plan review.
